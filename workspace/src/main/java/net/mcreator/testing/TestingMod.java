...
import net.mcreator.testing.init.TestingModItems;
import net.mcreator.testing.init.TestingModBlocks;
...
public class TestingMod {
	...
	public TestingMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TestingModBlocks.REGISTRY.register(modEventBus);
		TestingModBlockEntities.REGISTRY.register(modEventBus);
		TestingModItems.REGISTRY.register(modEventBus);
		TestingModMenus.REGISTRY.register(modEventBus);
